...
public class Bear extends Predator {
    ...
    public void eat(Herbivore food) {
        ...
        if (food instanceof Horse && eat < 0.4 && food.getX() == this.getX() && food.getY() == this.getY() && Horse.atomicInteger.get() > 0) {
        ...
        else if (food instanceof Dear && eat < 0.8 && food.getX() == this.getX() && food.getY() == this.getY() && Dear.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
        ...
        else if (food instanceof Rabbit && eat < 0.8 && food.getX() == this.getX() && food.getY() == this.getY() && Rabbit.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
        ...
        else if (food instanceof Goat && eat < 0.7 && food.getX() == this.getX() && food.getY() == this.getY() && Goat.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
        ...
        else if (food instanceof Boar && eat < 0.5 && food.getX() == this.getX() && food.getY() == this.getY() && Boar.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
        ...
        else if (food instanceof Buffalo && eat < 0.2 && food.getX() == this.getX() && food.getY() == this.getY() && Buffalo.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
        ...
        else if (food instanceof Duck && eat < 0.1 && food.getX() == this.getX() && food.getY() == this.getY() && Duck.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
    ...
    public void eat(Snake food) {
        if (eat < 0.8 &&  food.getX() == this.getX() && food.getY() == this.getY() && Snake.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_BEAR) {
                setMaxWeigth(Settings.MAX_WEIGHT_BEAR);
            }
            Snake.atomicInteger.getAndDecrement();
            food = null;
        }
    }
