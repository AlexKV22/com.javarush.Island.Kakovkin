...
public class Snake extends Predator {
    ...
    public void eat(Herbivore food) {
        ...
        if (food instanceof Mouse && eat < 0.4 && food.getX() == this.getX() && food.getY() == this.getY() && Mouse.atomicInteger.get() > 0) {
        ...
        else if (food instanceof Rabbit && eat < 0.2 && food.getX() == this.getX() && food.getY() == this.getY() && Rabbit.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_SNAKE) {
                setMaxWeigth(Settings.MAX_WEIGHT_SNAKE);
            }
    ...
    public void eat(Fox food) {
        if (eat < 0.15 && food.getX() == this.getX() && food.getY() == this.getY() && Fox.atomicInteger.get() > 0) {
            if(food.getMaxWeigth() >= Settings.MAX_FOOD_NEEDED_SNAKE) {
                setMaxWeigth(Settings.MAX_WEIGHT_SNAKE);
            }
